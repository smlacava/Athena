...
function batch_measureExtraction(parameters, dataPath, measure, cf)
    ...
    for m = 1:n_measures
        ...
        elseif strcmpi(measure{m}, 'Mean') || strcmpi(measure{m}, ...
                'Median') || strcmpi(measure{m}, 'Variance') || ...
                strcmpi(measure{m}, 'Standard_deviation') || ...
                strcmpi(measure{m}, 'Kurtosis') || strcmpi(measure{m}, ...
                'Skewness')
