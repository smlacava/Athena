function varargout = Athena_tfPath(varargin)
    ...
    gui_State = struct('gui_Name',       mfilename, ...
        ...
        'gui_OpeningFcn', @Athena_tfPath_OpeningFcn, ...
        'gui_OutputFcn',  @Athena_tfPath_OutputFcn, ...
        'gui_LayoutFcn',  [] , ...
        'gui_Callback',   []);
...
function varargout = Athena_tfPath_OutputFcn(hObject, eventdata, handles) 
...
function next_Callback(~, eventdata, handles)
    ...
    if exist(dataPath, 'dir')
        ...
        Athena_tfShow(dataPath, measure, sub, loc, sub_types)
    else
