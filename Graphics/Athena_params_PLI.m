%Athena_params_PLI (Automatic Toolbox for Handling Easy Neural Analyzes)
function varargout = Athena_params_PLI(varargin)

% Begin initialization code
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Athena_params_PLI_OpeningFcn, ...
                   'gui_OutputFcn',  @Athena_params_PLI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Athena_params_PLI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = Athena_params_PLI_OutputFcn(hObject, eventdata, handles) 
